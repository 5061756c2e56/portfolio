# Portfolio optimisation, scalability, and security
...
- A single function, **parseMultiRepoQueryParams**, in **lib/github/route-params.ts**, centralises this logic and returns either validated parameters or a 400 error response.
...
### Centralised API errors

- Error messages across routes mixed French and English and were scattered in individual files.
- A **lib/github/errors.ts** module now centralises error codes, messages (in English for the API), and HTTP statuses. Routes use **apiError('CODE', options)** to return consistent error responses.
...
- Over 7 days and 30 days, rendering and hover behaviour remain correct.
