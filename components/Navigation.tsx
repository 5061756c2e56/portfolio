                ...
                <div className="flex items-center justify-between h-16 gap-4 overflow-visible">
                    ...
                    >
                        {christmasMode ? (
                            ...
                            <div className="relative w-6 h-6 rounded-full overflow-hidden border-2 border-border/60 hover:border-primary/50 transition-all duration-300 flex-shrink-0">
                                <Image
                                    src="/pfp.png"
                                    alt="Paul Viandier"
                                    fill
