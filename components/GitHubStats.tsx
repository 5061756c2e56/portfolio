                        ...
                        {statCards.map((card, index) => (
                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    <div className="flex items-center gap-3 mb-4 text-foreground/70 group-hover:text-primary transition-colors duration-300">
                                        {card.icon}
                                        <span className="text-sm sm:text-base font-medium">{card.label}</span>
                                    </div>
                                    <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-foreground group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-primary group-hover:to-accent transition-all duration-300">
