...
import { CheckCircle2, Regex, RotateCcw, Sparkles, Trophy, XCircle, Zap } from 'lucide-react';
    ...
    const challenges = useMemo<Challenge[]>(() => {
        ...
        return order.map((id) => {
            ...
            return {
                ...
                input: getText(`challenges.${id}.input`),
                options,
                ...
                <div className="grid gap-4">
                    ...
                    {isCorrect ? t('feedback.correct') : t('feedback.incorrect')}
                        ...
                        <div className="rounded-xl border border-blue-500/10 bg-muted/40 p-4">
                            <div className="text-sm text-muted-foreground mb-2">{current.goal}</div>
                            <pre
