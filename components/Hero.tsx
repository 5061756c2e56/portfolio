            ...
            <div
                ...
                <div className="flex justify-center">
                    <button
                        ...
                        className={`group inline-flex items-center justify-center gap-3 px-8 py-4 text-base font-medium rounded-lg bg-foreground text-background transition-all duration-300 hover:bg-foreground/90 ${
                    ...
                    >
                        ...
                        <span>{isDownloading ? t('downloadingCV') : t('downloadCVButton')}</span>
                    </button>
                </div>
            </div>
        </section>
