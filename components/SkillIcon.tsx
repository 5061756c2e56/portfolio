    ...
    const icons: Record<string, React.ReactElement<SVGProps<SVGSVGElement>>> = {
        ...
        'TypeScript': (
            <svg className={iconClassName} viewBox="0 0 24 24" fill="currentColor">
                <path
                    d="M1.125 0C.502 0 0 .502 0 1.125v21.75C0 23.498.502 24 1.125 24h21.75c.623 0 1.125-.502 1.125-1.125V1.125C24 .502 23.498 0 22.875 0zm17.363 9.75c.612 0 1.154.037 1.627.111a6.38 6.38 0 0 1 1.306.34v2.458a3.95 3.95 0 0 0-.643-.361 5.093 5.093 0 0 0-.717-.26 5.453 5.453 0 0 0-1.426-.2c-.3 0-.573.028-.819.086a2.1 2.1 0 0 0-.623.242c-.17.104-.3.229-.393.374a.888.888 0 0 0-.14.49c0 .196.053.373.156.529.104.156.252.304.443.444s.423.276.696.41c.273.135.582.274.926.416.47.197.892.407 1.266.628.374.222.695.473.963.753.268.279.472.598.614.957.142.359.214.776.214 1.253 0 .657-.125 1.21-.373 1.656a3.033 3.033 0 0 1-1.012 1.085 4.38 4.38 0 0 1-1.487.596c-.566.12-1.163.18-1.79.18a9.916 9.916 0 0 1-1.84-.164 5.544 5.544 0 0 1-1.512-.493v-2.63a5.217 5.217 0 0 0 3.237 1.2c.333 0 .624-.03.872-.09.249-.06.456-.144.623-.25.166-.108.29-.234.373-.38a1.023 1.023 0 0 0-.074-1.089 2.12 2.12 0 0 0-.537-.5 5.597 5.597 0 0 0-.807-.444 7.647 7.647 0 0 0-1.007-.436c-.918-.383-1.602-.852-2.053-1.405-.45-.553-.676-1.222-.676-2.005 0-.614.123-1.141.369-1.582.246-.44.58-.804 1.004-1.09a4.494 4.494 0 0 1 1.47-.629 5.851 5.851 0 0 1 1.77-.268zm-15.113.188h9.563v2.166H9.506v9.646H6.789v-9.646H3.375z"/>
            </svg>
        ),
        'CSS': (
            <svg className={iconClassName} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        'NextJS': (
            <svg className={`${iconClassName} text-black`} viewBox="0 0 24 24" fill="none"
        ...
        'NodeJS': (
            <svg className={iconClassName} viewBox="-16.5 0 289 289" version="1.1" xmlns="http://www.w3.org/2000/svg"
        ...
        'PostgreSQL': (
            <svg className={iconClassName} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                ...
                <g id="SVGRepo_iconCarrier">
                    <path style={{ fill: '#E2E5E7' }}
                          d="M128,0c-17.6,0-32,14.4-32,32v448c0,17.6,14.4,32,32,32h320c17.6,0,32-14.4,32-32V128L352,0H128z"></path>
                    ...
                    <path style={{ fill: '#F15642' }}
                          d="M416,416c0,8.8-7.2,16-16,16H48c-8.8,0-16-7.2-16-16V256c0-8.8,7.2-16,16-16h352c8.8,0,16,7.2,16,16 V416z"></path>
                    <g>
                        ...
                        <path style={{ fill: '#FFFFFF' }}
                              d="M293.168,303.152c0-4.224,3.584-7.808,8.064-7.808c4.096,0,7.552,3.6,7.552,7.808v64.096h34.8 c12.528,0,12.8,16.752,0,16.752h-42.336c-4.48,0-8.064-3.184-8.064-7.792v-73.056H293.168z"></path>
                    </g>
