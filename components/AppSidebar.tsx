...
export function AppSidebar() {
    ...
    useEffect(() => {
        ...
        const handleScroll = () => {
            ...
            const viewportThreshold = scrollPosition + windowHeight * 0.4;
            ...
            for (let i = sections.length - 1; i >= 0; i--) {
                ...
                if (element) {
                    ...
                    if (isLastSection) {
                        if (scrollPosition + windowHeight >= elementTop - 150 || viewportThreshold >= elementTop) {
                            active = section;
                            break;
                        }
                    } else {
                        if (viewportThreshold >= elementTop && viewportThreshold < elementBottom) {
                            active = section;
                            break;
                        }
                    }
                        ...
                        <div className="px-3 pb-2">
                            ...
                            <div className="space-y-1">
                                <button
                                    ...
                                    disabled={isPending}
                                    className={cn(
                                        'w-full flex items-center gap-2 rounded-md px-3 py-2 text-sm transition-colors disabled:opacity-50 disabled:cursor-not-allowed',
                                        currentLocale === 'fr'
